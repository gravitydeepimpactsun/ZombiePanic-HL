...
public:
	...
	void		R_SetFrustum (Vector vangles, Vector vorigin, float viewsize);
	void		R_SetFrustum (Vector vangles, Vector vorigin, float view_hor, float view_ver, float dist);
...
extern Vector vec_to_eyes;

extern Vector sky_origin;
extern Vector sky_world_origin;
