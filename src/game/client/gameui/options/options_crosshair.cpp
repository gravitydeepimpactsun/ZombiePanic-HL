    ...
    : BaseClass(parent, "CrosshairSubOptions")
{
	...
	m_pEnableCvar = new CCvarCheckButton(this, "EnableCvar", "#ZP_AdvOptions_Cross_Enable", "cl_cross_enable");

	m_pColorLabel = new vgui2::Label(this, "ColorLabel", "#ZP_AdvOptions_Cross_Color");
	m_pColorCvar = new CCvarColor(this, "ColorCvar", nullptr, "#ZP_AdvOptions_Cross_Color_Title");

	m_pGapLabel = new vgui2::Label(this, "GapLabel", "#ZP_AdvOptions_Cross_Gap");
	m_pGapCvar = new CCvarTextEntry(this, "GapCvar", "cl_cross_gap", CCvarTextEntry::CvarType::Int);

	m_pSizeLabel = new vgui2::Label(this, "SizeLabel", "#ZP_AdvOptions_Cross_Size");
	m_pSizeCvar = new CCvarTextEntry(this, "SizeCvar", "cl_cross_size", CCvarTextEntry::CvarType::Int);

	m_pThicknessLabel = new vgui2::Label(this, "ThicknessLabel", "#ZP_AdvOptions_Cross_Thickness");
	m_pThicknessCvar = new CCvarTextEntry(this, "ThicknessCvar", "cl_cross_thickness", CCvarTextEntry::CvarType::Int);

	m_pOutlineThicknessLabel = new vgui2::Label(this, "OutlineThickness", "#ZP_AdvOptions_Cross_OutThickness");
	...
	m_pDotCvar = new CCvarCheckButton(this, "DotCvar", "#ZP_AdvOptions_Cross_Dot", "cl_cross_dot");

	m_pTCvar = new CCvarCheckButton(this, "TCvar", "#ZP_AdvOptions_Cross_T", "cl_cross_t");
