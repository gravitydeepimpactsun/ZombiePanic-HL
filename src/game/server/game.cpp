...
cvar_t roundtime = { "mp_roundtime", "10", FCVAR_SERVER };
...
ConVar mp_respawn_delay("mp_respawn_delay", "2", 0, "Time until palyers can respawn after death. Requires mp_respawn_fix 1.");
...
cvar_t mp_dmg_cz75 = { "mp_dmg_cz75", "8", FCVAR_SERVER };
...
cvar_t mp_dmg_sks = { "mp_dmg_sks", "15", FCVAR_SERVER };
...
cvar_t mp_item_medkit_medium = { "mp_item_medkit_medium", "50", FCVAR_SERVER };
cvar_t mp_item_medkit_small = { "mp_item_medkit_small", "50", FCVAR_SERVER };
...
void GameDLLInit(void)
{
	...
	CVAR_REGISTER(&mp_item_medkit_medium);
	CVAR_REGISTER(&mp_item_medkit_small);
